<?php
/**
 * HTML- Get product brands fields.
 * 
 * @since 11.3.0
 */
if (!defined('ABSPATH')) {
...
<div class='fgf-field-wrapper'>
	...
	<span class='fgf-field'>
		<select class='fgf_rule_type fgf-get-product-selection-type-field fgf-get-product-selection-type-field-brand fgf_select2' name='fgf_rule[fgf_get_product_brands][]' multiple='multiple'>
			<?php
