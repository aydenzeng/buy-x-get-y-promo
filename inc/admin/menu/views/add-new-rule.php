...
<div class="woocommerce fgf_rule_wrapper fgf_new_rule">
	<h2><?php esc_html_e('New Free Gift Rule', 'buy-x-get-y-promo'); ?></h2>
	...
	?>
	<p class="submit">
		<input name='fgf_save' class='button-primary fgf_save_btn' type='submit' value="<?php esc_attr_e('Add Rule', 'buy-x-get-y-promo'); ?>" />
